// Load the data from a transitions tsv file
...
:params {importFile: 'file:///Z:/graph_transitions/goldman.tsv'}
...
WITH
  ...
  coalesce(row[17], 'Unknown') AS sourceTitle,
...
WITH
  ...
  coalesce(row[31], 'Unknown') AS targetTitle,
